...
export default {
  ...
  methods: {
    getdata() {
      axios
        ...
        .then((response) => {
          ...
          this.sub(this.Sky,this.Landscape,this.Type);
    ...
    sub(List1,List2,List3){
      temple.push.apply(temple,List1),
      temple.push.apply(temple,List2),
      temple.push.apply(temple,List3),
      this.waterfallData=temple,
      console.log(temple)
    }
  },
};
